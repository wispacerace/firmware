...
size_t /* TODO: use optional */ xbus_buf2msg(XbusParsedMessage *msg, uint8_t *buffer, size_t buf_size) {
    ...
    while (parsing) {
        ...
        //     case XbusParserState::ExtendedLengthMSB: printf("ExtendedLengthMSB\n"); break;
        //     case XbusParserState::ExtendedLengthLSB: printf("ExtendedLengthLSB\n"); break;
        //     case XbusParserState::Payload: printf("Payload\n"); break;
        //     case XbusParserState::Checksum: printf("Checksum\n"); break;
        // }
